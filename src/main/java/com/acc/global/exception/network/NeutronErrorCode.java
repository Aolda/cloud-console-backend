...
public enum NeutronErrorCode implements ErrorCode {
    ...
    NEUTRON_ROUTER_CREATION_FAILED(500, "ACC-NEUTRON-ROUTER-CREATION-FAILED", "Neutron 라우터 생성에 실패했습니다."),
    NEUTRON_ROUTER_DELETION_FAILED(500, "ACC-NEUTRON-ROUTER-DELETION-FAILED", "Neutron 라우터 삭제에 실패했습니다."),
    NEUTRON_ROUTER_RETRIEVAL_FAILED(500, "ACC-NEUTRON-ROUTER-RETRIEVAL-FAILED", "Neutron 라우터 조회에 실패했습니다."),
    ...
    NEUTRON_SUBNET_RETRIEVAL_FAILED( 500, "ACC-NEUTRON-SUBNET-RETRIEVAL-FAILED", "Neutron 서브넷 조회에 실패했습니다.");
