...
public interface ImageDocs {
    ...
    @Operation(
            ...
            description = "URL을 통해 새 이미지를 생성합니다.\n\n"
                    ...
                    + "- metadata.diskFormat: 디스크 포맷 (qcow2 | raw | vhd | vhdx | vmdk | vdi | iso | ploop | aki | ari | ami)\n"
                    + "- metadata.containerFormat: 컨테이너 포맷 (bare | ovf | ova | docker | compressed | aki | ari | ami)\n"
                    + "- fileUrl: 이미지 파일 URL\n\n"
                    + "**선택 정보**\n"
