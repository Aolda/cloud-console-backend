...
public interface ImageDocs {
    ...
    @Operation(
            ...
            description = "URL을 통해 새 이미지를 생성합니다.\n\n"
                    ...
                    + "- metadata.diskFormat: 디스크 포맷 (Enum) (QCOW2 | RAW | VHD | VHDX | VMDK | VDI | ISO | PLOOP | AKI | ARI | AMI)\n"
                    + "- metadata.containerFormat: 컨테이너 포맷 (Enum) (BARE | OVF | OVA | DOCKER | COMPRESSED | AKI | ARI | AMI)\n"
                    + "- fileUrl: 이미지 파일 URL\n\n"
                    + "**선택 정보**\n"
