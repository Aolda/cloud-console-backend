...
public class InstanceTypeCreateRequest {
    ...
    @Schema(description = "인스턴스 타입(Flavor) 이름", example = "tb1.micro")
    private String typeName;

    @Schema(description = "아키텍처 타입 (Enum 참조)", implementation = Architecture.class, example = "X86")
    private Architecture architect;

    @Schema(description = "인스턴스 유형/목적 (Enum 참조)", implementation = Purpose.class, example = "GENERAL")
