...
public record GetNoticeResponse(
    ...
    public static GetNoticeResponse from(String noticeId, String title, String content,
                                        String createdBy, LocalDateTime createdAt,
                                        LocalDateTime startsAt, LocalDateTime endsAt) {
        return new GetNoticeResponse(noticeId, title, content, createdBy, createdAt, startsAt, endsAt);
    }
}