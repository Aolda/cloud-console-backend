...
public class CreateKeypairResponse {
    ...
    @Schema(description = "생성된 공개 키", example = "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQC... Generated-by-Nova")
    private String publicKey;

    @Schema(description = "생성된 개인 키 (생성 응답 시에만 반환됩니다. 재발급 불가능합니다.", example = "-----BEGIN RSA PRIVATE KEY-----\nMIIEpAIBAAKCAQEA... \n-----END RSA PRIVATE KEY-----")
